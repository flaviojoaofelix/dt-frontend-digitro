        ...
        <div className="col-sm-9 col-md-7 col-lg-5 mx-auto">
          <div className="card border-0 shadow rounded-3 my-5">
            <div className="card-body p-4 p-sm-5">
              <img src="/logo-digitro.png" className="card-img-top mx-auto d-block responsive-image" alt="Logotipo Dígitro Tecnologia" />
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="d-grid">
                  <button type="submit" className="btn btn-primary btn-login text-uppercase fw-bold">Conectar</button>
                </div>
              </form>
            </div>
          </div>
